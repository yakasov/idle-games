...
// @match        file:///C:/dev-personal/idle-games/Endless%20Stairwell/Endless%20Stairwell%20TAS/Endless%20Stairwell.html
...
class Section5 extends Section4 {
    ...
    get shouldCocoaPrestige() {
        return (
            ...
            (game.roomsExplored >= 1000 && game.cocoaHoney.lt("10^^^10^^2")) ||
...
class Section7 extends Section5 {
    ...
    get shouldCocoaPrestige() {
        if (game.roomsExplored >= 1000 && game.currentFloor < 350) {
            return true;
        }
...
let s9 = new Section9(7, {
    ...
    3: ExpantaNum.expansion(10, 1.3e6),
