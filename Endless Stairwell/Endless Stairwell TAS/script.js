...
function save() {
    if (game.fightingMonster == false) {
        localStorage.setItem("endlessStairwellSave", JSON.stringify(game));
    }
}
...
function loadGame(loadgame) {
    ...
    for (i = 0; i < Object.keys(loadgame).length; i++) {
        if (loadgame[Object.keys(loadgame)[i]] != "undefined") {
            if (typeof loadgame[Object.keys(loadgame)[i]] == "string") {
                game[Object.keys(loadgame)[i]] = new ExpantaNum(
    ...
    if (game.smithFloor == 0) {
        ...
        if (!game.floorsWithRooms[0].includes(x)) {
            game.smithFloor = x;
        } else if (!game.floorsWithRooms[0].includes(x - 1)) {
            game.smithFloor = x - 1;
        } else if (!game.floorsWithRooms[0].includes(x - 2)) {
            game.smithFloor = x - 2;
        } else if (!game.floorsWithRooms[0].includes(x - 3)) {
            game.smithFloor = x - 3;
        } else {
            game.smithFloor = x - 4;
        }
        game.floorsWithRooms[0] = game.floorsWithRooms[0].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 2) {
        ...
        if (game.floorsWithRooms[1].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[1].includes(x)) {
                    game.floorsWithRooms[1].push(x);
                } else if (!game.floorsWithRooms[1].includes(x - 1)) {
                    game.floorsWithRooms[1].push(x - 1);
                } else if (!game.floorsWithRooms[1].includes(x - 2)) {
                    game.floorsWithRooms[1].push(x - 2);
                } else {
                    game.floorsWithRooms[1].push(x - 3);
                }
            }
        }
        game.floorsWithRooms[1] = game.floorsWithRooms[1].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 3) {
        ...
        if (game.floorsWithRooms[2].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[2].includes(x)) {
                    game.floorsWithRooms[2].push(x);
                } else if (!game.floorsWithRooms[2].includes(x - 1)) {
                    game.floorsWithRooms[2].push(x - 1);
                } else if (!game.floorsWithRooms[2].includes(x - 2)) {
                    game.floorsWithRooms[2].push(x - 2);
                } else {
                    game.floorsWithRooms[2].push(x - 3);
                }
            }
        }
        game.floorsWithRooms[2] = game.floorsWithRooms[2].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 4) {
        ...
        if (game.floorsWithRooms[3].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[3].includes(x)) {
                    game.floorsWithRooms[3].push(x);
                } else if (!game.floorsWithRooms[3].includes(x - 1)) {
                    game.floorsWithRooms[3].push(x - 1);
                } else if (!game.floorsWithRooms[3].includes(x - 2)) {
                    game.floorsWithRooms[3].push(x - 2);
                } else {
                    game.floorsWithRooms[3].push(x - 3);
                }
            }
        }
        game.floorsWithRooms[3] = game.floorsWithRooms[3].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 5) {
        ...
        if (game.floorsWithRooms[4].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[4].includes(x)) {
                    game.floorsWithRooms[4].push(x);
                } else if (!game.floorsWithRooms[4].includes(x - 1)) {
                    game.floorsWithRooms[4].push(x - 1);
                } else if (!game.floorsWithRooms[4].includes(x - 2)) {
                    game.floorsWithRooms[4].push(x - 2);
                } else {
                    game.floorsWithRooms[4].push(x - 3);
                }
            }
        }
        game.floorsWithRooms[4] = game.floorsWithRooms[4].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 6) {
        ...
        if (game.floorsWithRooms[5].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[5].includes(x)) {
                    game.floorsWithRooms[5].push(x);
                } else if (!game.floorsWithRooms[5].includes(x - 1)) {
                    game.floorsWithRooms[5].push(x - 1);
                } else if (!game.floorsWithRooms[5].includes(x - 2)) {
                    game.floorsWithRooms[5].push(x - 2);
                } else {
                    game.floorsWithRooms[5].push(x - 3);
                }
            }
        }
        game.floorsWithRooms[5] = game.floorsWithRooms[5].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 7) {
        ...
        if (game.floorsWithRooms[6].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[6].includes(x)) {
                    game.floorsWithRooms[6].push(x);
                } else if (!game.floorsWithRooms[6].includes(x - 1)) {
                    game.floorsWithRooms[6].push(x - 1);
                } else if (!game.floorsWithRooms[6].includes(x - 2)) {
                    game.floorsWithRooms[6].push(x - 2);
                } else {
                    game.floorsWithRooms[6].push(x - 3);
                }
            }
        }
        game.floorsWithRooms[6] = game.floorsWithRooms[6].sort(function (a, b) {
            return a - b;
        });
    }
    if (game.floorsWithRooms.length < 8) {
        ...
        if (game.floorsWithRooms[7].length == 0) {
            for (i = 0; i < 4; i++) {
                ...
                if (!game.floorsWithRooms[7].includes(x)) {
                    game.floorsWithRooms[7].push(x);
                } else if (!game.floorsWithRooms[7].includes(x - 1)) {
                    game.floorsWithRooms[7].push(x - 1);
                } else if (!game.floorsWithRooms[7].includes(x - 2)) {
                    game.floorsWithRooms[7].push(x - 2);
                } else {
                    game.floorsWithRooms[7].push(x - 3);
                }
            }
            for (i = 0; i < 4; i++) {
        ...
        game.floorsWithRooms[7] = game.floorsWithRooms[7].sort(function (a, b) {
            return a - b;
        });
    }
    ...
    document.getElementById("macIcon").style.display = "none";
    ...
    for (i = 0; i < cbmRequirements.length; i++) {
        document.getElementsByClassName("cocoaBarMilestoneDiv")[
            i
        ].style.backgroundColor = "#c0b070";
    }

    updateInfo();
    if (game.currentFloor >= 50 && game.specialItemsAcquired[1] == false) {
        ...
        game.currentFloor >= 150 &&
        game.sharkUpgradesBought[9] != true
    ) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (game.currentFloor >= 200 && game.cocoaBars < 20) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (
        game.currentFloor >= 250 &&
        game.combinatorUpgradesBought[9] != true
    ) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (
        game.currentFloor >= 300 &&
        game.combinatorUpgrades2Bought[10] != true
    ) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (
        game.currentFloor >= 304 &&
        game.monsterBloodUpgradesBought[9] != true
    ) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (
        game.currentFloor >= 350 &&
        game.sharkUpgrades2Bought[6] != true
    ) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (game.currentFloor >= 499 && game.goldenEelDefeated != true) {
        document.getElementById("floorUpButton").disabled = true;
    ...
    if (game.currentFloor <= 0 && game.cocoaBars < 10 && game.darkOrbs == 0) {
    ...
    if (game.roomsExplored > 0) {
        ...
        if (game.currentFloor > 50) {
            tierMessage = ", tier 2";
        } else {
            tierMessage = "";
        }
        if (game.roomsExplored == 1) {
            $("#info").html(
                "<b>Info</b><br>You are in an endless expanse of rooms. They all contain the same beige carpet, and are sparingly littered with furniture. It feels like something's in here with you...<br><br>You have explored 1 room. You are 1 room away from the stairwell. This floor's difficulty is " +
                    game.floorDifficulty +
                    tierMessage +
                    "."
            );
        } else {
            $("#info").html(
                "<b>Info</b><br>You are in an endless expanse of rooms.<br><br>You have explored " +
                    game.roomsExplored +
                    " rooms. You are " +
                    game.roomsFromStairwell +
                    " rooms away from the stairwell. This floor's difficulty is " +
                    game.floorDifficulty +
                    tierMessage +
                    "."
            );
    ...
    if (game.specialItemsAcquired[0] == true) {
    ...
    if (game.xp.gte(4980021) && game.sharkUpgradesBought[0] != true) {
    ...
    if (
        game.cocoaHoney.gt(0) ||
        JSON.stringify(game.altarUpgradesBought) !=
            "[false,false,false,false,false,false,false]"
    ) {
        document.getElementById("cocoaDiv").style.display = "block";
    }
    for (i = 0; i < game.altarUpgradesBought.length; i++) {
        if (game.altarUpgradesBought[i] == true) {
            document.getElementsByClassName("cocoaUpgrade")[i].disabled = true;
        } else {
    ...
    for (i = 0; i < game.sharkUpgradesBought.length; i++) {
        if (game.sharkUpgradesBought[i] == true) {
            document.getElementsByClassName("sharkUpgrade")[i].disabled = true;
        } else {
    ...
    if (game.darkOrbs >= 1) {
        ...
        )[5].style.backgroundColor = "#40d040";
        document.getElementById("honey3").style.display = "block";
        document.getElementById("honeyText3").style.display = "block";
        document.getElementById("cocoaBarIcon").style.display = "block";
        document.getElementById("cocoaBarText").style.display = "block";
    ...
    if (game.darkOrbs >= 3) {
        document.getElementsByClassName(
            "cocoaBarMilestoneDiv"
        )[3].style.backgroundColor = "#40d040";
    }
    if (game.darkOrbs >= 4) {
    ...
    for (i = 0; i < game.combinatorUpgradesBought.length; i++) {
        if (game.combinatorUpgradesBought[i] == true) {
            document.getElementsByClassName("combinatorUpgrade")[
                i
            ].disabled = true;
        } else {
            document.getElementsByClassName("combinatorUpgrade")[
    ...
    if (game.combinatorUpgradesBought.length == 4)
        game.combinatorUpgradesBought = [
            false,
            false,
            false,
            false,
    ...
    if (game.combinatorUpgradesBought[0] == true) {
        ...
        document.getElementsByClassName("combinatorText")[0].innerHTML =
            "Hyperplasm";
    }
    ...
    if (game.combinatorUpgradesBought[3] == true) {
        ...
        document.getElementsByClassName("combinatorText")[1].innerHTML =
            "Dark bar";
    }
    if (game.combinatorUpgradesBought[4] == true) {
        document.getElementsByClassName("combinatorButton")[2].disabled = false;
        document.getElementsByClassName("combinatorText")[2].innerHTML =
            "Star bar";
    }
    ...
    for (i = 0; i < game.combinatorUpgrades2Bought.length; i++) {
        if (game.combinatorUpgrades2Bought[i] == true) {
            document.getElementsByClassName("combinatorUpgrade2")[
                i
            ].disabled = true;
        } else {
            document.getElementsByClassName("combinatorUpgrade2")[
    ...
    for (i = 0; i < game.monsterBloodUpgradesBought.length; i++) {
        if (game.monsterBloodUpgradesBought[i] == true) {
            document.getElementsByClassName("monsterBloodUpgrade")[
                i
            ].disabled = true;
        } else {
            document.getElementsByClassName("monsterBloodUpgrade")[
    ...
    if (game.sharkCutscenesViewed == 3) {
        for (i = 0; i < game.sharkUpgrades2Bought.length; i++)
            document.getElementsByClassName("sharkUpgrade2")[i].style.display =
                "inline-block";
    } else {
        for (i = 0; i < game.sharkUpgrades2Bought.length; i++)
            document.getElementsByClassName("sharkUpgrade2")[i].style.display =
    ...
    for (i = 0; i < game.sharkUpgrades2Bought.length; i++) {
        if (game.sharkUpgrades2Bought[i] == true) {
            document.getElementsByClassName("sharkUpgrade2")[i].disabled = true;
        } else {
            document.getElementsByClassName("sharkUpgrade2")[
                i
            ].disabled = false;
        }
    }
    ...
    for (i = 0; i < game.goldenUpgradesBought.length; i++) {
        if (game.goldenUpgradesBought[i] == true) {
            document.getElementsByClassName("goldenUpgrade")[i].disabled = true;
        } else {
            document.getElementsByClassName("goldenUpgrade")[
                i
            ].disabled = false;
        }
    }
    ...
    if (game.finalTime > 0) {
        ...
        finalTimeString =
            finalTimePlayedHours +
            ":" +
            ((finalTimePlayedMinutes < 10 ? "0" : "") +
                finalTimePlayedMinutes) +
            ":" +
            ((finalTimePlayedSeconds < 10 ? "0" : "") + finalTimePlayedSeconds);
...
function timePlayedUp() {
    ...
    timeString =
        timePlayedHours +
        ":" +
        ((timePlayedMinutes < 10 ? "0" : "") + timePlayedMinutes) +
        ":" +
        ((timePlayedSeconds < 10 ? "0" : "") + timePlayedSeconds);
...
function updateSmall() {
    ...
    game.maxHealth = ExpantaNum(100)
        .mul(ExpantaNum(1.1).pow(game.level.sub(1)))
        .floor();
    if (game.health.gt(game.maxHealth)) game.health = game.maxHealth;
    if (game.health.gt("10^^10")) {
        $("#healthBarText").html(format(game.health, 0));
    } else {
        $("#healthBarText").html(
            format(game.health, 0) + "/" + format(game.maxHealth, 0)
        );
    }
    document.getElementById("healthBarInner").style.width =
        game.health.div(game.maxHealth).mul(100).toNumber() + "%";
    $("#energyBarText").html(Math.floor(game.energy) + "%");
    document.getElementById("energyBarInner").style.width = game.energy + "%";

    if (game.goldenHoney == 0) {
        game.attackDamage = ExpantaNum(10)
            .mul(ExpantaNum(1.1).pow(game.level.sub(1)))
            .floor();
    } else {
        game.attackDamage = ExpantaNum.expansion(11, game.goldenHoney + 5);
    }
    ...
    if (game.honey.eq(0)) {
        document.getElementById("honeyButton1").disabled = true;
    } else {
        document.getElementById("honeyButton1").disabled = false;
    }
    if (game.vanillaHoney.eq(0)) {
        document.getElementById("honeyButton2").disabled = true;
    } else {
        document.getElementById("honeyButton2").disabled = false;
    }
    ...
    if (game.buffTimes[0] > 0) {
        document.getElementById("buff1").style.opacity = "1";
    } else {
        document.getElementById("buff1").style.opacity = "0.5";
    }
    document.getElementsByClassName("buffText")[0].innerHTML =
        game.buffTimes[0];
    if (game.buffTimes[1] > 0) {
        document.getElementById("buff2").style.opacity = "1";
    } else {
        document.getElementById("buff2").style.opacity = "0.5";
    }
    document.getElementsByClassName("buffText")[1].innerHTML =
        game.buffTimes[1];
    if (game.buffTimes[2] > 0) {
        document.getElementById("buff3").style.opacity = "1";
    } else {
        document.getElementById("buff3").style.opacity = "0.5";
    }
    document.getElementsByClassName("buffText")[2].innerHTML =
        game.buffTimes[2];

    $("#fleeCooldown").html(game.fleeCooldown);
    if (game.specialItemsAcquired[1] == true)
        $("#fleeCooldownInfo").html(
            "Flee cooldown: " + game.fleeCooldown + "s"
        );
    if (game.energy == 100) {
    ...
    nextCocoaHoneyRequirement = ExpantaNum(500).mul(
        ExpantaNum(2).pow(cocoaHoneyToGet)
    );
    $("#nextCocoaHoneyRequirement").html(format(nextCocoaHoneyRequirement, 0));
    if (game.altarUpgradesBought[2] == true)
        cocoaHoneyToGet = cocoaHoneyToGet.mul(game.vanillaHoney.add(1));
    if (game.sharkUpgradesBought[1] == true)
        cocoaHoneyToGet = cocoaHoneyToGet.mul(2);
    if (game.sharkUpgradesBought[5] == true)
        cocoaHoneyToGet = cocoaHoneyToGet.mul(2);
    if (game.darkOrbs >= 2) {
        if (game.cocoaBars >= 4) {
            cocoaHoneyToGet = cocoaHoneyToGet.pow(game.cocoaBars * 500 + 1);
        } else {
            cocoaHoneyToGet = cocoaHoneyToGet.pow(game.cocoaBars * 100 + 1);
        }
    } else {
        if (game.cocoaBars >= 4) {
            cocoaHoneyToGet = cocoaHoneyToGet.pow(game.cocoaBars * 10 + 1);
        } else {
            cocoaHoneyToGet = cocoaHoneyToGet.pow(game.cocoaBars * 2 + 1);
        }
    }
    if (game.cocoaBars >= 9)
        cocoaHoneyToGet = cocoaHoneyToGet.mul(ExpantaNum("10^^10"));
    ...
    if (game.honey.gte(20) && game.honeyplasm.gte(1)) {
        document.getElementById("sharkTrade").disabled = false;
    } else {
        document.getElementById("sharkTrade").disabled = true;
    }

    if (game.cocoaBars >= 10 + game.darkOrbs * 5) {
        cocoaBarRequirement = ExpantaNum("Infinity");
    } else {
        cocoaBarRequirement = cocoaBarRequirements[game.cocoaBars];
    }
    $("#cocoaBarRequirement").html(format(cocoaBarRequirement, 0));
    $("#cocoaBars").html(game.cocoaBars);

    $("#darkOrbs").html(game.darkOrbs);
    $("#darkOrbRequirement").html(
        format(darkOrbRequirements[game.darkOrbs], 0)
    );

    $("#hyperplasm").html(format(game.hyperplasm, 0));
    if (game.combinatorUpgradesBought[5] == true) {
        hyperplasmCost = ExpantaNum(10).pow(
            ExpantaNum(10).pow(
                ExpantaNum(2).pow(game.hyperplasm.div(1000).add(1).tetr(1.2))
            )
        );
        $("#hyperplasmGain").html("1,000");
    } else {
        hyperplasmCost = ExpantaNum(10).pow(
            ExpantaNum(10).pow(game.hyperplasm.add(1).tetr(1.2))
        );
    ...
    if (game.combinatorUpgradesBought[7] == true) {
        starBarCost = 1 + game.starBars;
    } else {
        starBarCost = 4 + game.starBars;
    }
    $("#starBarCost").html(starBarCost);

    $("#goldenHoney").html(format(game.goldenHoney, 0));

    $("#goldenEelBarText").html(
        "K" + format(game.goldenEelHealth, 0) + "/K1.000e15"
    );
    document.getElementById("goldenEelBarInner").style.width =
        (game.goldenEelHealth / 1e15) * 100 + "%";
...
function updateInfo() {
    if (game.roomsExplored == 0) {
        if (game.currentFloor == 0) {
            if (game.cocoaBars >= 10 || game.darkOrbs > 0) {
                $("#info").html(
                    "<b>Info</b><br>You are in a seemingly endless stairwell. The stairs are carpeted in beige, and the walls are warm and bright. The landings are lit by continuous windows with nothing but white on the other side.<br><br>The stairs below are now open to you."
                );
            } else {
                $("#info").html(
                    "<b>Info</b><br>You are in a seemingly endless stairwell. The stairs are carpeted in beige, and the walls are warm and bright. The landings are lit by continuous windows with nothing but white on the other side.<br><br>You feel safe to go up, but a paralyzing fear sets in when you try to go below the ground floor."
                );
            }
        } else if (
            game.currentFloor == 50 &&
            game.specialItemsAcquired[1] == false
        ) {
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 50. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 50 &&
            game.specialItemsAcquired[1] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The stairs above appear cold and grey, like an old office."
            );
        } else if (
            game.currentFloor == 100 &&
            game.altarUpgradesBought[6] != true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 100. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 100 &&
            game.altarUpgradesBought[6] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The landings above are indented and filled ankle-deep with water. The walls are covered in tiles."
            );
        } else if (
            game.currentFloor == 150 &&
            game.sharkUpgradesBought[9] != true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 150. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 150 &&
            game.sharkUpgradesBought[9] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The stairs above are lined with plush carpet, with warm lighting giving the stairwell a comforting atmosphere."
            );
        } else if (game.currentFloor == 200 && game.cocoaBars < 20) {
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 200. You may have to do something to be able to travel further..."
            );
        } else if (game.currentFloor == 200 && game.cocoaBars >= 20) {
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The stairs above are a loose dark wood, with weak bulbs hanging above. A cold breeze fills the atmosphere."
            );
        } else if (
            game.currentFloor == 250 &&
            game.combinatorUpgradesBought[9] != true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 250. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 250 &&
            game.combinatorUpgradesBought[9] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The stairwell above appears high-class, with detailed wooden walls and smooth marble floors."
            );
        } else if (
            game.currentFloor == 300 &&
            game.combinatorUpgrades2Bought[10] != true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 300. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 300 &&
            game.combinatorUpgrades2Bought[10] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The walls above are a dark stone, dripping with mysterious blood. The air is humid and everything smells nasty."
            );
        } else if (
            game.currentFloor == 304 &&
            game.monsterBloodUpgradesBought[9] != true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 304. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 304 &&
            game.monsterBloodUpgradesBought[9] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The landings above are indented and filled ankle-deep with water, just like back in Shark's area. The walls are covered in tiles."
            );
        } else if (
            game.currentFloor == 350 &&
            game.sharkUpgrades2Bought[6] != true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. Going any higher leads you right back to floor 350. You may have to do something to be able to travel further..."
            );
        } else if (
            game.currentFloor == 350 &&
            game.sharkUpgrades2Bought[6] == true
            ...
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell. The stairwell above is entirely covered in glistening gold."
            );
        } else if (game.currentFloor == 500) {
            $("#info").html(
                "<b>Info</b><br>You are at the top of a non-endless stairwell.<br><br>You step out of the doorway into a large, uninhabited forest. Mountains stretch into the distance, and the air smells fresher than anywhere in the stairwell. The long journey is over."
            );
        } else {
            $("#info").html(
                "<b>Info</b><br>You are in a seemingly endless stairwell."
            );
        }
        ...
        if (game.currentFloor == game.smithFloor) {
            $("#floorContentsInfo").html(
                "This floor has some kind of smithing area. Maybe you'll<br>be able to find some runes to use at it?"
            );
            document.getElementById("enterFloorButton").style.display = "none";
            if (game.currentTip == 2 || game.currentTip == 3)
                game.currentTip = 4;
        }
        //Smith 2 floor
        ...
        //Blue door floor
            ...
            if (game.specialItemsAcquired[0]) {
                ...
                $("#floorContentsInfo").html(
                    "This floor has a <span style='color: #303090'>blue door</span> with a keyhole. It seems you have the key for it."
                );
            } else {
                document.getElementById("enterFloorButton").disabled = true;
                $("#floorContentsInfo").html(
                    "This floor has a <span style='color: #303090'>blue door</span> with a keyhole. It is locked. Maybe if you become stronger you'll be able to gain the key?"
                );
            }
        }
        //Altar floor
            ...
            $("#floorContentsInfo").html(
                "This floor has some kind of sacrificial altar."
            );
            document.getElementById("enterFloorButton").style.display = "none";
            document.getElementById("prestigeHotkey").style.display = "block";
        ...
        //Shark shop floor
            ...
            $("#floorContentsInfo").html(
                "This floor has some kind of upgrade shop."
            );
            if (game.sharkCutscenesViewed == 3) {
                $("#sharkText").html("*Dead noises*");
                document.getElementById("shark").src = "img/sharkDead.png";
                document.getElementById("enterFloorButton").style.display =
                    "none";
            } else {
                $("#sharkText").html(
                    "Woah-oah my GOD, a CUSTOMER! Welcome, welcome! I have things! PLEASE BUY SOMETHING!!!!!!!"
                );
        ...
        //Cocoa bar floor
            ...
            $("#floorContentsInfo").html(
                "This floor has some kind of ingot forge."
            );
            document.getElementById("enterFloorButton").style.display = "none";
        ...
        //Gem eel boss floor
            ...
            document.getElementById("enterFloorButton").style.display = "block";
            $("#floorContentsInfo").html(
                "This floor has a massive door leading to a large boss room."
            );
        }
        //Shark 2 floor
            ...
            if (game.sharkCutscenesViewed == 0) {
                ...
                $("#sharkText2").html(
                    "I'll be waiting here until you can defeat Jelly!"
                );
                document.getElementById("continueButton").style.display =
                    "none";
            } else if (
        ...
        //Jelly boss floor
            ...
            if (game.jellyDefeated == true) {
                $("#floorContentsInfo").html(
                    "This floor has a door leading to an expansive shop. There's no point taking any items, they're all pretty terrible."
                );
            } else {
                $("#floorContentsInfo").html(
                    "This floor has a door leading to an expansive shop. You can hear some kind of asshole shopkeeper through the door."
                );
            }
        }
        //Dark orb floor
            ...
            $("#floorContentsInfo").html(
                "This floor has an enormous dark room, dimly lit with candles all around. In the middle sits a large, unknown machine."
            );
            document.getElementById("enterFloorButton").style.display = "none";
        } else if (
            game.floorsWithRooms[0].includes(game.currentFloor) ||
            game.floorsWithRooms[1].includes(game.currentFloor) ||
            game.floorsWithRooms[2].includes(game.currentFloor) ||
            game.floorsWithRooms[3].includes(game.currentFloor) ||
            game.floorsWithRooms[4].includes(game.currentFloor) ||
            game.floorsWithRooms[5].includes(game.currentFloor) ||
            game.floorsWithRooms[6].includes(game.currentFloor) ||
            game.floorsWithRooms[7].includes(game.currentFloor)
        ) {
            document.getElementById("enterFloorButton").disabled = false;
            $("#floorContentsInfo").html(
                "This floor has a door leading to a variety of rooms."
            );
            document.getElementById("enterFloorButton").style.display = "block";
        } else {
            $("#floorContentsInfo").html("");
        ...
        if (game.currentFloor == game.smithFloor) {
            document.getElementsByClassName("smithDiv")[0].style.display =
                "block";
        } else {
            document.getElementsByClassName("smithDiv")[0].style.display =
                "none";
        }
        if (game.currentFloor == game.smithFloor + 1) {
            document.getElementsByClassName("smithDiv")[1].style.display =
                "block";
        } else {
            document.getElementsByClassName("smithDiv")[1].style.display =
                "none";
        }
        if (game.currentFloor == 99) {
            document.getElementById("altarDiv").style.display = "block";
        } else {
            document.getElementById("altarDiv").style.display = "none";
        }
        if (game.currentFloor == 149) {
            document.getElementById("sharkShopDiv").style.display = "block";
        } else {
            document.getElementById("sharkShopDiv").style.display = "none";
        }
        if (game.currentFloor == 151) {
            document.getElementById("cocoaBarDiv").style.display = "block";
        } else {
            document.getElementById("cocoaBarDiv").style.display = "none";
        }
        if (game.currentFloor == 248) {
            document.getElementById("combinatorDiv").style.display = "block";
        } else {
            document.getElementById("combinatorDiv").style.display = "none";
        }
        if (game.currentFloor == 249) {
            document.getElementById("combinatorUpgradeDiv").style.display =
                "block";
        } else {
            document.getElementById("combinatorUpgradeDiv").style.display =
                "none";
        }
        if (game.currentFloor == 299) {
            document.getElementById("combinatorUpgrade2Div").style.display =
                "block";
        } else {
            document.getElementById("combinatorUpgrade2Div").style.display =
                "none";
        ...
        if (game.currentFloor == 301) {
            ...
            document.getElementById("monsterBloodDiv").style.display = "none";
        }
        if (game.currentFloor == 302) {
            document.getElementById("monsterBloodUpgradeDiv").style.display =
                "block";
        } else {
            document.getElementById("monsterBloodUpgradeDiv").style.display =
                "none";
        }
        if (game.currentFloor == 305) {
            document.getElementById("shark2Div").style.display = "block";
        } else {
            document.getElementById("shark2Div").style.display = "none";
        }
        if (game.currentFloor == 351) {
            document.getElementById("goldenUpgradeDiv").style.display = "block";
        } else {
            document.getElementById("goldenUpgradeDiv").style.display = "none";
        }
        if (game.currentFloor == 499) {
            ...
            if (game.goldenEelDefeated == false) {
                ...
                document.getElementById("goldenEel").src =
                    "img/enemy37dead.png";
                document.getElementById("goldenEelBar").style.display = "none";
                document.getElementById("goldenEelAttackInfo").style.display =
                    "none";
                document.getElementById("goldenEelAttackButton").style.display =
                    "none";
        ...
        if (game.currentFloor == -1) {
            document.getElementById("darkOrbDiv").style.display = "block";
        } else {
            document.getElementById("darkOrbDiv").style.display = "none";
        }
    }
}
...
function fillTipHistory() {
    for (i = 0; i <= game.currentTip; i++) {
        if (i != 10) {
            if (i < 10) {
                $("#tipHistory").html(
                    document.getElementById("tipHistory").innerHTML +
                        "<b>" +
                        (i + 1) +
                        ". </b>" +
                        tips[i] +
...
function floorUp() {
    ...
    if (game.currentFloor == 50 && game.specialItemsAcquired[1] == false)
        document.getElementById("floorUpButton").disabled = true;
    else if (game.currentFloor >= 100 && game.altarUpgradesBought[6] != true) {
        document.getElementById("floorUpButton").disabled = true;
    } else if (
        game.currentFloor >= 150 &&
        game.sharkUpgradesBought[9] != true
...
Mousetrap.bind("down", function () {
    if (document.getElementById("floorDownButton").disabled == false)
        floorDown();
});
...
function enterFloor() {
    ...
    if (game.currentFloor == 49) {
        game.floorDifficulty = 6;
    } else if (game.currentFloor == 303) {
        ...
        for (j = 0; j < game.floorsWithRooms.length; j++) {
            for (i = 0; i < game.floorsWithRooms[j].length; i++) {
                if (game.currentFloor == game.floorsWithRooms[j][i]) {
                    game.floorDifficulty = i + 1;
                }
            }
        }
    }
    ...
    if (game.currentFloor > 350) {
        tierMessage = ", tier 8";
        $("#info").html(
            "<b>Info</b><br>You are in an endless expanse of rooms. The rooms are completely covered in gold, to the point that it hurts your eyes.<br><br>You have explored 1 room. You are 1 room away from the stairwell. This floor's difficulty is " +
                game.floorDifficulty +
                tierMessage +
                "."
        );
        ...
        tierMessage = ", tier 7";
        $("#info").html(
            "<b>Info</b><br>You are in an endless expanse of rooms. Every room contains knee-deep water with stairs to the doors, and blue tiled walls.<br><br>You have explored 1 room. You are 1 room away from the stairwell. This floor's difficulty is " +
                game.floorDifficulty +
                tierMessage +
                "."
        );
        ...
        tierMessage = ", tier 6";
        $("#info").html(
            "<b>Info</b><br>You are in an endless expanse of rooms. These rooms are beautifully decorated, with rich dark wooden walls and smooth marble floors. Various seats, tables and carpets line the spaces.<br><br>You have explored 1 room. You are 1 room away from the stairwell. This floor's difficulty is " +
                game.floorDifficulty +
                tierMessage +
                "."
        );
        ...
        tierMessage = ", tier 5";
        $("#info").html(
            "<b>Info</b><br>You are in an endless expanse of rooms. Instead of rooms, the stairwell's doors open up to a field and paths at night, dotted with street lights and filled with a thick fog. Trees create circles around fields resembling the rooms of the floors below.<br><br>You have explored 1 room. You are 1 room away from the stairwell. This floor's difficulty is " +
                game.floorDifficulty +
                tierMessage +
                "."
        );
        ...
        tierMessage = ", tier 2";
        $("#info").html(
            "<b>Info</b><br>You are in an endless expanse of rooms. They contain a variety of office furniture, with some bland paintings on the walls.<br><br>You have explored 1 room. You are 1 room away from the stairwell. This floor's difficulty is " +
                game.floorDifficulty +
                tierMessage +
                "."
        );
...
function newRoom() {
    ...
    if (
        game.currentFloor > 250 &&
        game.currentFloor <= 300 &&
        game.totalDifficulty.gt(5) &&
        game.combinatorUpgrades2Bought[5] != true
    )
        game.totalDifficulty = ExpantaNum(5);
    $("#info").html(
        "<b>Info</b><br>You are in an endless expanse of rooms.<br><br>You have explored " +
            game.roomsExplored +
            " rooms. You are " +
...
function toStairwell() {
    if (game.roomsFromStairwell <= 1) {
        ...
        document.getElementById("floorUpButton").style.display = "block";
        document.getElementById("floorDownButton").style.display = "block";
        if (game.currentFloor == 349 && game.jellyDefeated == true) {
            document.getElementById("enterFloorButton").style.display = "none";
        } else {
            document.getElementById("enterFloorButton").style.display = "block";
        }
        ...
        if (game.altarUpgradesBought[4] == true) {
            document.getElementById("toGroundFloorButton").style.display =
                "block";
            document.getElementById("toFloor49Button").style.display = "block";
            document.getElementById("toFloor99Button").style.display = "block";
        }
        ...
        if (game.roomsFromStairwell != 1) {
            ...
            $("#info").html(
                "<b>Info</b><br>You are in an endless expanse of rooms.<br><br>You have explored " +
                    game.roomsExplored +
                    " rooms. You are 1 room away from the stairwell. This floor's difficulty is " +
                    game.floorDifficulty +
                    tierMessage +
                    "."
            );
...
function roomCheck() {
    if (game.roomsExplored % 10 == 0 && !game.returningToStairwell) {
...
function monsterEncounter() {
    ...
    //Monster type
    game.fightingMonster = true;
    if (game.monstersKilled == 0 && game.currentFloor <= 50) {
        monsterType = 1;
    } else if (game.currentFloor <= 50) {
        monsterType = 2;
    } else if (game.currentFloor <= 100) {
        ...
        monsterType = 30;
    } else if (game.currentFloor <= 498) {
        monsterType = 33;
    }
    document.getElementById("monsterIcon").src =
        "img/enemy" + monsterType + ".png";
    document.getElementById("monsterName").innerHTML =
        monsters[monsterType - 1].name;

    //Monster health
    if (game.currentFloor > 350) {
        game.monsterMaxHealth = ExpantaNum.expansion(
            11,
            Math.ceil(10 ** (game.totalDifficulty - 1))
        );
    } else if (game.currentFloor == 349) {
        game.monsterMaxHealth = ExpantaNum("JJ10000");
        game.jellyFought = true;
    } else if (game.currentFloor > 304) {
        game.monsterMaxHealth = ExpantaNum(
            "J" +
                ExpantaNum.hyper(
                    monsters[monsterType - 1].health
                        .mul(game.totalDifficulty.sub(0.6))
                        .sub(2)
                        .floor()
                )(10, 2)
        );
    } else if (game.currentFloor == 303) {
        game.monsterMaxHealth = ExpantaNum(gemEelLevels[game.gemEelsBeaten]);
    } else if (game.currentFloor > 250) {
        game.monsterMaxHealth = ExpantaNum.hyper(
            monsters[monsterType - 1].health
                .mul(game.totalDifficulty.sub(0.7))
                .floor()
        )(10, 2).mul("10^^10");
    } else if (game.currentFloor > 200) {
        game.monsterMaxHealth = ExpantaNum(10).pent(
            ExpantaNum(20).pow(
                monsters[monsterType - 1].health.pow(
                    game.totalDifficulty.sub(1.3)
                )
            )
        );
    } else if (game.currentFloor > 150) {
        game.monsterMaxHealth = ExpantaNum(10).tetr(
            ExpantaNum(monsters[monsterType - 1].health)
                .mul(0.8)
                .mul(game.totalDifficulty)
                .sub(6)
        );
    } else if (game.currentFloor > 100) {
        game.monsterMaxHealth = ExpantaNum(10).pow(
            ExpantaNum(10).pow(
                monsters[monsterType - 1].health **
                    ExpantaNum(0).mul(0.25).sub(0.2).add(game.totalDifficulty) // might break ?
            )
        );
    } else if (game.currentFloor > 50) {
        game.monsterMaxHealth = monsters[monsterType - 1].health
            .mul(ExpantaNum(1.5).pow(game.totalDifficulty.mul(3).sub(1)))
            .floor();
    } else {
        game.monsterMaxHealth = monsters[monsterType - 1].health
            .mul(ExpantaNum(1.5).pow(game.totalDifficulty.sub(1)))
            .floor();
    }
    game.monsterHealth = game.monsterMaxHealth;
    if (game.currentFloor > 100) {
        $("#monsterHealthBarText").html(format(game.monsterHealth, 0));
    } else {
        $("#monsterHealthBarText").html(
            format(game.monsterHealth, 0) +
                "/" +
                format(game.monsterMaxHealth, 0)
        );
    }
    document.getElementById("monsterHealthBarInner").style.width =
        format(game.monsterHealth.div(game.monsterMaxHealth).mul(100), 1) + "%";

    //Monster damage
    if (game.currentFloor > 100) {
        $("#monsterDamage").html(format(game.monsterMaxHealth), 0);
    } else if (game.currentFloor > 50) {
        $("#monsterDamage").html(
            format(
                monsters[monsterType - 1].damage
                    .mul(
                        ExpantaNum(1.2).pow(game.totalDifficulty.mul(3).sub(1))
                    )
                    .floor(),
                0
            )
        ...
        $("#monsterDamage").html(
            format(
                monsters[monsterType - 1].damage
                    .mul(ExpantaNum(1.3).pow(game.totalDifficulty.sub(1)))
                    .floor(),
                0
            )
        );
    }
    if (game.altarUpgradesBought[3] == true) {
        game.monsterAttackCooldown = 4.5;
    } else {
...
function randomItem() {
    if (Math.floor(Math.random() * 100) >= 25) {
        if (Math.floor(Math.random() * 3) == 0) {
            ...
            $("#roomInfo").html(
                document.getElementById("roomInfo").innerHTML +
                    "<br><span style='color: #b00000'>+1 red rune fragment</span>"
            );
        } else if (Math.floor(Math.random() * 2) == 0) {
            game.runeFragments[1]++;
            $("#roomInfo").html(
                document.getElementById("roomInfo").innerHTML +
                    "<br><span style='color: #00b000'>+1 green rune fragment</span>"
            );
        } else {
            game.runeFragments[2]++;
            $("#roomInfo").html(
                document.getElementById("roomInfo").innerHTML +
                    "<br><span style='color: #0000b0'>+1 blue rune fragment</span>"
            );
        }
    } else if (Math.floor(Math.random() * 100) >= 40) {
        if (game.darkOrbs >= 4) {
            game.honey = game.honey.add(1e10 * 2 ** game.cocoaBars);
        } else if (game.darkOrbs >= 3) {
            game.honey = game.honey.add(10000 * 2 ** game.cocoaBars);
        } else if (game.darkOrbs >= 2) {
            game.honey = game.honey.add(100 * 2 ** game.cocoaBars);
        } else if (game.darkOrbs >= 1) {
            game.honey = game.honey.add(10 * 2 ** game.cocoaBars);
        } else {
            game.honey = game.honey.add(1);
        }
        $("#roomInfo").html(
            document.getElementById("roomInfo").innerHTML +
                "<br><span style='color: #e8a830'>+1 honey</span>"
        );
        $("#honey").html(format(game.honey, 0));
    } else {
        if (game.currentFloor == 49 && game.specialItemsAcquired[1] != true) {
            ...
            $("#roomInfo").html(
                document.getElementById("roomInfo").innerHTML +
                    "<br><span style='color: gold'>+1 lucky ring</span>"
            );
            ...
            $("#roomInfo").html(
                document.getElementById("roomInfo").innerHTML +
                    "<br><span style='color: #303090'>+1 blue key</span>"
            );
            if (game.currentTip == 5) game.currentTip = 6;
        } else {
            if (game.darkOrbs >= 4) {
                game.vanillaHoney = game.vanillaHoney.add(
                    1e10 * 2 ** game.cocoaBars
                );
            } else if (game.darkOrbs >= 3) {
                game.vanillaHoney = game.vanillaHoney.add(
                    10000 * 2 ** game.cocoaBars
                );
            } else if (game.darkOrbs >= 2) {
                game.vanillaHoney = game.vanillaHoney.add(
                    100 * 2 ** game.cocoaBars
                );
            } else if (game.darkOrbs >= 1) {
                game.vanillaHoney = game.vanillaHoney.add(
                    10 * 2 ** game.cocoaBars
            ...
            $("#roomInfo").html(
                document.getElementById("roomInfo").innerHTML +
                    "<br><span style='color: #e8c070'>+1 vanilla honey</span>"
            );
            $("#vanillaHoney").html(format(game.vanillaHoney, 0));
        }
    }
...
function attack() {
    if (game.energy > 0) {
        game.energy = Math.max(
            Math.round(game.energy - (4 + 20 / game.timeSinceAttack)),
            0
        );
        game.timeSinceAttack = 1;
        if (game.currentFloor == 349 && game.sharkCutscenesViewed == 2) {
            game.monsterHealth = ExpantaNum(0);
        } else {
            game.monsterHealth = game.monsterHealth.sub(game.attackDamage);
        }
    ...
    if (game.waitingForEnergy == false) {
        if (game.energy < 100 && game.energy > 0) {
            if (game.roomsExplored == 0) {
                game.energy +=
                    1.6 *
                    (1 + (game.buffTimes[2] > 0) * 0.75) *
                    (1 + game.bluePermanentBought * 0.1);
            } else {
                game.energy =
                    game.energy +
                    0.8 *
                        (1 + (game.buffTimes[2] > 0) * 0.75) *
                        (1 + game.bluePermanentBought * 0.1) *
                        0.99 ** Math.max(game.roomsExplored - 100, 0);
            }
            ...
            }, 2000 * 1.005 ** Math.max(game.roomsExplored - 100, 0));
        }
    }
}
...
function monsterAttack() {
    if (game.fightingMonster == true) {
        if (game.monsterAttackCooldown >= 0.1) {
            game.monsterAttackCooldown = Math.max(
                game.monsterAttackCooldown - 0.1,
                0
            );
        } else {
            if (game.currentFloor == 499) {
                ...
                if (game.currentFloor > 100) {
                    game.health = game.health
                        .sub(game.monsterMaxHealth)
                        .floor();
                } else if (game.currentFloor > 50) {
                    game.health = game.health.sub(
                        monsters[monsterType - 1].damage
                            .mul(
                                ExpantaNum(1.2).pow(
                                    game.totalDifficulty.mul(3).sub(1)
                                )
                            )
                            .floor()
                    );
                    ...
                    game.health = game.health.sub(
                        monsters[monsterType - 1].damage
                            .mul(
                                ExpantaNum(1.3).pow(game.totalDifficulty.sub(1))
                            )
                            .floor()
                    );
                }
...
function battleWin() {
    if (game.currentFloor <= 100) {
        xpToGet = game.monsterMaxHealth.div(10).pow(1.3).mul(cocoaBoost);
    } else if (game.currentFloor <= 150) {
        xpToGet = game.monsterMaxHealth.log().pow(0.4).mul(cocoaBoost);
    } else if (game.currentFloor <= 200) {
        if (game.cocoaBars >= 15) {
            xpToGet = game.monsterMaxHealth.tetr(
                ExpantaNum(500).mul(game.totalDifficulty.div(2).add(0.5))
            );
        } else if (game.cocoaBars >= 13) {
            xpToGet = game.monsterMaxHealth.tetr(
                ExpantaNum(100).mul(game.totalDifficulty.div(2).add(0.5))
            );
        } else if (game.cocoaBars >= 11) {
            xpToGet = game.monsterMaxHealth.tetr(
                ExpantaNum(25).mul(game.totalDifficulty.div(2).add(0.5))
            );
        } else {
            xpToGet = game.monsterMaxHealth.tetr(
                ExpantaNum(6).mul(game.totalDifficulty.div(2).add(0.5))
            );
        }
        if (game.darkOrbs >= 2)
            xpToGet = xpToGet.tetr(game.totalDifficulty.mul(15));
        if (game.cocoaBars >= 16)
            xpToGet = xpToGet.tetr(
                game.totalDifficulty.mul(20 ** (game.cocoaBars - 13))
            );
    } else if (game.currentFloor <= 250) {
        xpToGet = game.monsterMaxHealth.pent(
            ExpantaNum(20)
                .pow(
                    monsters[monsterType - 1].health
                        .pow(game.totalDifficulty.sub(1))
                        .mul(1.2)
                        .mul(game.darkBars * 0.1 + 1)
                )
                .ceil()
        );
        if (game.darkOrbs >= 4)
            xpToGet = xpToGet.pent(
                ExpantaNum(20)
                    .pow(
                        monsters[monsterType - 1].health
                            .pow(game.totalDifficulty.sub(1))
        ...
        if (game.combinatorUpgrades2Bought[9] == true) {
            xpToGet = ExpantaNum.hyper(
                monsters[monsterType - 1].health
                    .mul(game.totalDifficulty.sub(0.3))
                    .mul(25)
                    .mul(1 + (game.cocoaBars >= 26) * 0.2)
                    .mul(1 + (game.cocoaBars >= 30) * 1000)
                    .mul(game.starBars)
                    .mul(game.monsterBlood.add(1))
                    .pow(game.darkOrbs)
                    .floor()
            )(10, 10);
        } else if (game.combinatorUpgrades2Bought[7] == true) {
            xpToGet = ExpantaNum.hyper(
                monsters[monsterType - 1].health
                    .mul(game.totalDifficulty.sub(0.3))
                    .mul(25)
        ...
        } else if (game.combinatorUpgrades2Bought[3] == true) {
            xpToGet = ExpantaNum.hyper(
                monsters[monsterType - 1].health
                    .mul(game.totalDifficulty.sub(0.3))
                    .mul(25)
        ...
        } else if (game.combinatorUpgrades2Bought[2] == true) {
            xpToGet = ExpantaNum.hyper(
                monsters[monsterType - 1].health
                    .mul(game.totalDifficulty.sub(0.3))
                    .mul(5)
        ...
        } else if (game.combinatorUpgrades2Bought[1] == true) {
            xpToGet = ExpantaNum.hyper(
                monsters[monsterType - 1].health
                    .mul(game.totalDifficulty.sub(0.3))
                    .mul(2)
        ...
        xpToGet = ExpantaNum(0);
    } else if (game.currentFloor > 304 && game.currentFloor <= 348) {
        if (game.sharkUpgrades2Bought[5] == true) {
            xpToGet = ExpantaNum(
                "JJ" +
                    ExpantaNum.hyper(
                        monsters[monsterType - 1].health
                            .mul(game.totalDifficulty.sub(0.3))
                            .mul(game.bloodGems ** 2)
                            .floor()
                    )(10, 10)
            );
        } else if (game.sharkUpgrades2Bought[4] == true) {
            xpToGet = ExpantaNum(
                "JJ" +
                    ExpantaNum.hyper(
                        monsters[monsterType - 1].health
        ...
        } else if (game.sharkUpgrades2Bought[3] == true) {
            xpToGet = ExpantaNum(
                "JJ" +
                    ExpantaNum.hyper(
                        monsters[monsterType - 1].health
        ...
        } else if (game.sharkUpgrades2Bought[2] == true) {
            xpToGet = ExpantaNum(
                "J" +
                    ExpantaNum.hyper(
                        ExpantaNum(10).pent(
        ...
        } else if (game.sharkUpgrades2Bought[1] == true) {
            xpToGet = ExpantaNum(
                "J" +
                    ExpantaNum.hyper(
                        ExpantaNum(10).tetr(
                ...
                "J" +
                    ExpantaNum.hyper(
                        monsters[monsterType - 1].health
                            .mul(game.totalDifficulty.sub(0.3))
                            .floor()
                    )(10, 10).mul(game.monsterBlood)
            );
        }
    } else if (game.currentFloor == 349) {
        xpToGet = ExpantaNum(0);
    } else if (game.currentFloor > 350) {
        xpToGet = game.monsterMaxHealth;
    }

    xpToGet = xpToGet.mul(1 + game.redPermanentBought * 0.05);
    if (
        game.level.lte(10) &&
        (game.cocoaHoney.eq(0) || game.altarUpgradesBought[0] == true)
    )
        xpToGet = xpToGet.mul(
            ExpantaNum(1).add(ExpantaNum(10).sub(game.level).mul(0.05))
        );
    ...
    if (
        game.xp.add(xpToGet).gte(4980021) &&
    ...
    if (
        game.level.gte(10) &&
        (game.currentTip == 2 || game.currentTip == 3 || game.currentTip == 4)
    )
        game.currentTip = 5;

    honeyplasmToGet = ExpantaNum(1);
    if (game.sharkUpgradesBought[3] == true)
        honeyplasmToGet = honeyplasmToGet.mul(game.vanillaHoney.add(1));
    ...
    if (
        ...
        game.currentFloor > 200 &&
        game.currentFloor <= 250
    ) {
        if (game.combinatorUpgradesBought[6] == true) {
            game.honey = game.honey.add(
                ExpantaNum(10).pow(
                    ExpantaNum(20).pow(
                        monsters[monsterType - 1].health
                            .pow(game.totalDifficulty.sub(1))
            ...
            game.honeyplasm = game.honeyplasm.add(
                ExpantaNum(10).pow(
                    ExpantaNum(20).pow(
                        monsters[monsterType - 1].health
                            .pow(game.totalDifficulty.sub(1))
    ...
    if (
        ...
        game.hyperplasm = game.hyperplasm.add(
            ExpantaNum(1.01).pow(
                monsters[monsterType - 1].health.pow(
                    game.totalDifficulty.sub(1)
                )
    ...
    if (game.currentFloor > 350 || game.goldenUpgradesBought[4] == true) {
        if (game.goldenUpgradesBought[8] == true) {
            game.goldenHoney += Math.floor(
                200000 *
                    Math.log(game.goldenHoney) *
                    game.bloodGems *
                    game.floorDifficulty
            );
        } else if (game.goldenUpgradesBought[7] == true) {
            game.goldenHoney += Math.floor(
                8 *
                    Math.log(game.goldenHoney) *
                    game.bloodGems *
        ...
        } else if (game.goldenUpgradesBought[6] == true) {
            game.goldenHoney += Math.floor(
                8 * Math.log(game.goldenHoney) * game.bloodGems
            );
        } else if (game.goldenUpgradesBought[5] == true) {
            game.goldenHoney += Math.floor(8 * Math.log(game.goldenHoney));
        } else if (game.goldenUpgradesBought[3] == true) {
            game.goldenHoney += 8;
        } else if (game.goldenUpgradesBought[2] == true) {
            game.goldenHoney += 4;
        } else if (game.goldenUpgradesBought[1] == true) {
            game.goldenHoney += 2;
        } else {
            game.goldenHoney++;
        }
...
function battleLose() {
    ...
    if (game.deaths > 1) {
        if (game.currentFloor > 100) {
            game.xp = game.xp.pow(0.5).ceil();
        } else if (game.currentFloor > 50) {
            game.xp = game.xp.div(2.5).ceil();
        } else {
            game.xp = game.xp.div(1.5).ceil();
        }
    }
    if (game.deaths == 1) {
        $("#deathInfo").html(
            "Since this is your first time, you won't be punished. But next time you'll lose XP, so be careful!"
        );
    } else {
        $("#deathInfo").html(
            "You've lost some of your XP.<br>This box is way too big for this message."
        );
    }
...
setInterval(function () {
    if (game.fleeCooldown > 0) game.fleeCooldown--;
}, 1000);
...
function consumeHoney(x) {
    if (x == 1 && game.honey.gt(0) && game.health.lt(game.maxHealth)) {
        ...
        game.waitingForEnergy = false;
        game.energy = Math.ceil(
            game.energy + 50 * 0.99 ** Math.max(game.roomsExplored - 100, 0)
        );
        if (game.energy > 100) game.energy = 100;
    }
}
...
function cocoaReset() {
    document.getElementById("cocoaDiv").style.display = "block";
    if (
        game.cocoaHoney.gte(5) &&
        (game.currentTip == 9 || game.currentTip == 10)
    )
        game.currentTip = 11;
    ...
    if (game.altarUpgradesBought[5] != true)
        game.specialItemsAcquired = [false, false];
    ...
    if (game.cocoaBars >= 5 || game.darkOrbs >= 3) {
        game.xp = cocoaBoost;
    } else if (game.cocoaBars >= 2) {
        game.xp = ExpantaNum(10000000);
    } else if (game.cocoaBars >= 1) {
        game.xp = ExpantaNum(500000);
    } else if (game.altarUpgradesBought[0] == true) {
        game.xp = ExpantaNum(5000);
    } else {
...
function fillFloorsWithRooms() {
    ...
    if (game.floorsWithRooms[0].length == 0) {
        for (i = 0; i < 4; i++) {
            ...
            if (!game.floorsWithRooms[0].includes(x)) {
                game.floorsWithRooms[0].push(x);
            } else if (!game.floorsWithRooms[0].includes(x - 1)) {
                game.floorsWithRooms[0].push(x - 1);
            } else if (!game.floorsWithRooms[0].includes(x - 2)) {
                game.floorsWithRooms[0].push(x - 2);
            } else {
                game.floorsWithRooms[0].push(x - 3);
            }
        }
    }
    if (game.smithFloor == 0) {
...
function randomSharkMessage() {
    if (game.sharkCutscenesViewed < 3) {
        if (Math.random > 0.5) {
            $("#sharkText").html(
                "YEAH, I BET YOU WANNA BE A [[Big Shark]]! AHAHAHAHA!!!"
            );
        } else {
            $("#sharkText").html(
...
function gainCocoaBars() {
    if (game.cocoaHoney.gte(cocoaBarRequirement)) {
        if (
            confirm(
                "Are you sure you want to do this? You will lose all of your cocoa honey!"
            )
        ) {
            game.cocoaBars++;
            cocoaReset();
...
function displayCBM(x) {
    ...
    if (x == 1) {
        $("#cocoaBarMilestoneText").html(
            "<span  style='font-size: 33px; line-height: 42px;'>1 cocoa bar</span><br>Keep 500,000 XP on reset"
        );
    } else if (x == 2) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>2 cocoa bars</span><br>Keep 10,000,000 XP on reset"
        );
    } else if (x == 3) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>4 cocoa bars</span><br>Cocoa bar effect is much stronger"
        );
    } else if (x == 4) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>5 cocoa bars</span><br>XP is set to cocoa boost amount on cocoa honey resets and cocoa bar resets"
        );
    } else if (x == 5) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>9 cocoa bars</span><br>Multiply cocoa honey gain by 1.000F10<br>Try killing some weak tier 4 enemies to get to the 10th cocoa bar!"
        );
    } else if (x == 6) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>10 cocoa bars</span><br>Gain access to <b>floor -1</b>"
        );
    } else if (x == 7) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>11 cocoa bars</span><br>Enemies above floor 150 drop more XP (1/3)"
        );
    } else if (x == 8) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>13 cocoa bars</span><br>Enemies above floor 150 drop more XP (2/3)"
        );
    } else if (x == 9) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>15 cocoa bars</span><br>Enemies above floor 150 drop more XP (3/3)"
        );
    } else if (x == 10) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>16 cocoa bars</span><br>Enemies above floor 150 drop more XP based on cocoa bars"
        );
    } else if (x == 11) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>19 cocoa bars</span><br>Cocoa honey gain is pentated by 2"
        );
    } else if (x == 12) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>20 cocoa bars</span><br>Forge your shadow ring into a cobalt ring"
        );
    } else if (x == 13) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>26 cocoa bars</span><br>Tier 6 enemies drop slightly more XP"
        );
    } else if (x == 14) {
        $("#cocoaBarMilestoneText").html(
            "<span style='font-size: 33px; line-height: 42px;'>30 cocoa bars</span><br>Tier 6 enemies drop far more XP"
        );
    }
}
...
function darkOrbPrestige() {
    if (game.cocoaHoney.gte(darkOrbRequirements[game.darkOrbs])) {
        if (
            confirm("Are you sure you want to reset EVERYTHING for a dark orb?")
        ) {
            game.darkOrbs++;
            darkOrbReset();
            $("#darkOrbBonuses").html(darkOrbBonuses[game.darkOrbs]);
...
function combinate(x) {
    if (
        x == 1 &&
        game.honey.gte(hyperplasmCost) &&
        game.honeyplasm.gte(hyperplasmCost)
    ) {
        game.honey = game.honey.sub(hyperplasmCost);
        game.honeyplasm = game.honeyplasm.sub(hyperplasmCost);
        if (game.combinatorUpgradesBought[5] == true) {
            game.hyperplasm = game.hyperplasm.add(1000);
        } else {
            game.hyperplasm = game.hyperplasm.add(1);
        }
    } else if (
        x == 2 &&
        game.cocoaBars >= darkBarCost1 &&
        game.darkOrbs >= darkBarCost2
    ) {
        game.darkBars++;
    } else if (
        x == 3 &&
        game.darkBars >= starBarCost &&
        game.hyperplasm.gte(20)
    ) {
        game.starBars++;
    }
}
...
function buyBloodProducer(x) {
    if (game.sharkUpgrades2Bought[0] == true) {
        if (x == 1 && ExpantaNum(game.bloodGems).gte(game.t1bp.mul(1000))) {
            ...
            x == 2 &&
            ExpantaNum(game.bloodGems).gte(game.t2bp.mul(1000).add(590))
        ) {
            game.t2bp = game.t2bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 3 &&
            ExpantaNum(game.bloodGems).gte(game.t3bp.mul(1000).add(650))
        ) {
            game.t3bp = game.t3bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 4 &&
            ExpantaNum(game.bloodGems).gte(game.t4bp.mul(1000).add(740))
        ) {
            game.t4bp = game.t4bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 5 &&
            ExpantaNum(game.bloodGems).gte(game.t5bp.mul(1000).add(800))
        ) {
            game.t5bp = game.t5bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 6 &&
            ExpantaNum(game.bloodGems).gte(game.t6bp.mul(1000).add(900))
        ) {
        ...
        if (x == 1 && ExpantaNum(game.bloodGems).gte(game.t1bp.mul(1000))) {
            ...
            x == 2 &&
            ExpantaNum(game.bloodGems).gte(game.t2bp.mul(1000).add(230))
        ) {
            game.t2bp = game.t2bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 3 &&
            ExpantaNum(game.bloodGems).gte(game.t3bp.mul(1000).add(270))
        ) {
            game.t3bp = game.t3bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 4 &&
            ExpantaNum(game.bloodGems).gte(game.t4bp.mul(1000).add(350))
        ) {
            game.t4bp = game.t4bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 5 &&
            ExpantaNum(game.bloodGems).gte(game.t5bp.mul(1000).add(400))
        ) {
            game.t5bp = game.t5bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 6 &&
            ExpantaNum(game.bloodGems).gte(game.t6bp.mul(1000).add(450))
        ) {
            game.t6bp = game.t6bp.add(1);
            bloodProductionUpdate();
        }
        ...
        if (x == 1 && ExpantaNum(game.bloodGems).gte(game.t1bp.add(1))) {
            ...
            x == 2 &&
            ExpantaNum(game.bloodGems).gte(game.t2bp.mul(3).add(6))
        ) {
            game.t2bp = game.t2bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 3 &&
            ExpantaNum(game.bloodGems).gte(game.t3bp.mul(10).add(15))
        ) {
            game.t3bp = game.t3bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 4 &&
            ExpantaNum(game.bloodGems).gte(game.t4bp.mul(18).add(36))
        ) {
            game.t4bp = game.t4bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 5 &&
            ExpantaNum(game.bloodGems).gte(game.t5bp.mul(30).add(66))
        ) {
            game.t5bp = game.t5bp.add(1);
            bloodProductionUpdate();
        } else if (
            x == 6 &&
            ExpantaNum(game.bloodGems).gte(game.t6bp.mul(50).add(136))
        ) {
            game.t6bp = game.t6bp.add(1);
            bloodProductionUpdate();
        }
...
function bloodProduction() {
    ...
    } else if (game.monsterBloodUpgradesBought[5] == true) {
        game.monsterBlood = game.monsterBlood.add(
            game.t1bp
                .add(game.t1ebp)
                .mul(game.bpMultiplier)
                .pow(1 + (game.monsterBloodUpgradesBought[5] == true))
                .pow(1 + (game.monsterBloodUpgradesBought[6] == true))
                .tetr(1 + (game.monsterBloodUpgradesBought[7] == true))
                .pent(1 + (game.monsterBloodUpgradesBought[8] == true))
        );
    } else {
        game.monsterBlood = game.monsterBlood.add(
            game.t1bp
    ...
    game.t1ebp = game.t1ebp.add(
        game.t2bp.add(game.t2ebp).mul(game.bpMultiplier)
    );
    game.t2ebp = game.t2ebp.add(
        game.t3bp.add(game.t3ebp).mul(game.bpMultiplier)
    );
    game.t3ebp = game.t3ebp.add(
        game.t4bp.add(game.t4ebp).mul(game.bpMultiplier)
    );
    game.t4ebp = game.t4ebp.add(
        game.t5bp.add(game.t5ebp).mul(game.bpMultiplier)
    );
...
function glockEffects() {
    ...
    document.getElementById("shine").style.transform =
        "translate(-50%, -50%) rotate(" + glockEffectPoint + "deg)";
}
...
function logKey(e) {
    document.getElementById("glock").style.left =
        45 + (e.clientX / window.innerWidth) * 10 + "%";
    document.getElementById("glock").style.top =
        45 + (e.clientY / window.innerWidth) * 10 + "%";
}

function closeGlockDiv() {
    document.getElementById("glockGetDiv").style.display = "none";
}

function buySharkUpgrade2(x) {
    if (
        x == 1 &&
        game.cocoaHoney.gte("JJ50") &&
...
function buyGoldenUpgrade(x) {
    if (
        x == 1 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 10)) &&
        ...
        x == 2 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 15)) &&
        ...
        x == 3 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 25)) &&
        ...
        x == 4 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 50)) &&
        ...
        x == 5 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 100)) &&
        ...
        x == 6 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 500)) &&
        ...
        x == 7 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 5000)) &&
        ...
        x == 8 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 15000000)) &&
        ...
        x == 9 &&
        game.cocoaHoney.gte(ExpantaNum.expansion(10, 1e8)) &&
